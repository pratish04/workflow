    ...
    <React.Fragment>
      ...
      <div className="tasks-body">
        <div className="project-data">
            <div><span>Title: </span>{project.projectTitle}</div>
            <div><span>Description: </span>{project.projectDescription}</div>
        ...
        </div>
        {
            ...
            <div className="create-new-window">
                ...
                <button className="close-button"
                    onClick={()=>{setDisplayCreateWindow(prevState=>!prevState)}}
                >X</button>
        ...
        {!displayCreateWindow 
            &&
            <button className="add-button" onClick={()=>{setDisplayCreateWindow(prevState=>!prevState)}}>
                Add Task +
            </button>
        }
        {!displayCreateWindow 
